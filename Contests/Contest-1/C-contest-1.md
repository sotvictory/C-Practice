...
# Задача 3
На стандартном потоке ввода подаются числа a, b и n. Числа a и b представимы типом int. Число n представимо типом int и больше 0.
...
Напишите функцию с прототипом `void process(struct List *pl, const char *str)`, которая обрабатывает список за один проход от первого до последнего элемента по нему следующим образом:
